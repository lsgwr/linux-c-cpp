...
不过大家也发现了**typedef的顺序和#define的顺序刚好相反**，很多同学总是容易搞混淆它们顺序

我们建议大家只记住其中一个，然后另一个的顺序刚好相反，这样就不会混淆了  
...
从前面的分析可以看出，使用#define来定义“新类型名”缺点不少，当我们自己写代码时，

**我们不建议使用#define来重命名“新类型名”，而是建议使用typedef来实现，typedef更规范**
