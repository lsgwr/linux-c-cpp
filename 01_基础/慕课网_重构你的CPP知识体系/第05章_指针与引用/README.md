...
> 对比Java，Java中所有的变量和类都在堆上，由类管理所有的东西，使用任何东西都得先new个类，没有栈这一说，不存在StackOverFlow的问题
...
## 5-20 引用
### 引用的基本使用
![引用的基本使用](images/引用的基本使用.png)

### 引用的使用规范
![引用的使用规范](images/引用的使用规范.png)